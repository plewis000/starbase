    ...
    >
      <div className="space-y-4">
        ...
        {filteredEntities.length > 0 && (
          <div className="py-2 border-b border-dungeon-800">
        ...
        <div className="space-y-2 max-h-64 overflow-y-auto">
          {loading ? (
            ...
            filteredEntities.map((entity) => (
              <label
                key={entity.id}
                className="flex items-center gap-3 p-2 rounded-lg hover:bg-dungeon-800/50 cursor-pointer transition-colors"
              >
                <input
                  type="checkbox"
        ...
        {/* Action Buttons */}
        <div className="flex gap-3 pt-4 border-t border-dungeon-800">
          <button
            onClick={onClose}
            className="flex-1 px-4 py-2 rounded-lg border border-dungeon-700 text-slate-300 hover:bg-dungeon-800/50 transition-colors text-sm font-medium"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 px-4 py-2 rounded-lg bg-red-400 hover:bg-red-500 disabled:bg-dungeon-700 disabled:cursor-not-allowed text-slate-950 transition-colors text-sm font-medium"
          >
