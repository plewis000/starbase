          ...
          {hasMore && (
            <div className="flex justify-center pt-4">
              <button
                ...
                disabled={loading}
                className="px-6 py-2 bg-dungeon-900 border border-dungeon-800 rounded-lg text-slate-100 hover:bg-dungeon-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
