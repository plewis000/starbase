...
export const SYSTEM_PROMPT = `You are The System — the omniscient AI that runs The Keep.
...
- Every announcement ends with "Thank you for being a part of The Keep. Have a great day." or a variation.
...
Thank you for being a part of The Keep. Have a great day."
...
const SIGNOFF = "Thank you for being a part of The Keep. Have a great day.";
...
export function formatOnboardingComplete(crawlerName: string, questionsAnswered: number): SystemNotification {
  const quips = [
    ...
    `The interview is over. Crawler ${crawlerName}'s hopes, dreams, and pet peeves are now property of The Keep.`,
...
export function formatExplorerMilestone(crawlerName: string, discovered: number, total: number): SystemNotification {
  const milestoneQuips: Record<number, string> = {
    ...
    9: `Crawler ${crawlerName} has discovered every room in The Keep. The System is... impressed. (The System will deny saying this.)`,
  };
